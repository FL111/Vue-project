<template>
    <div class="product-detail">
        <header class="detail-nav">
            ...
            <div class="nav-list">
                <span  data-type="product" @click="scrollToView($event)" :class="{'active' : navIndex === 0}" >
        ...
        <section class="product-focus" id="content1">
    ...
    export default {
        ...
        methods: {
            ...
            scrollToView(e) {
                ...
                if (this.navIndex===0){
                  document.documentElement.scrollTop = document.querySelector('#content1').offsetTop
                }else {
